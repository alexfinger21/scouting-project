...
export default class Reef extends DrawableObject {
    constructor({ctx, renderQueue, images, letter, canvasSize, pos, visible = true, zIndex = 10000}) {
        ...
        for(let i = ch - ((ch % 2) ? 3 : 2); i < ch + ((ch % 2) ? 2 : 3); i++ ) {
            ...
            this.letters.push(new Letter({ctx, renderQueue, text: String.fromCharCode(i), zIndex: zIndex+1, canvasSize, pos: {
